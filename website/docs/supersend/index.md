...
- Explore the [SuperSend API Swagger spec](https://uat.obansolutions.com.au/supersend/swagger/index.html) which provides a breakdown of all available endpoints that can be called.

# Documentation for Super Funds

Documentation for super funds implementing SuperAPI's Retain, Grow, and Rollover automations.

## Implementation overview

This provides a high-level overview of the steps required to integrate your fund with the SuperAPI.

[Read the superfund implementation guide](/funds/implementation_overview/index.html)

## Retain Implementation Overview

Retain is the high-level term used for functionality within SuperAPI that assists super funds to retain and engage their existing members.
